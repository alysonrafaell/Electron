const { app, BrowserWindow, ipcMain, Tray, Menu, nativeImage, powerSaveBlocker, globalShortcut, screen, shell} = require("electron");
...
const IpcHandlers = {
  setup() {
    ...
    ipcMain.on("open-github", () => {
      try {
        shell.openExternal("https://github.com/alysonrafaell");
      } catch (err) {
